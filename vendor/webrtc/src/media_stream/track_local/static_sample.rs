...
// A 1400-byte RTP packet remains below the standard 1500-byte Ethernet MTU
// after UDP/IP and SRTP overhead. Desktop frames need materially fewer packets
// than with the conservative 1200-byte WebRTC default.
...
impl TrackLocalStaticSample {
    ...
    pub async fn write_sample(
        ...
        self.rtp_track
            .write_rtp_batch_with_extensions(packets, extensions)
            .await
    }
}
