...
complete primary display at its Windows-scaled 1920x1200 size → upload to D3D11 for NV12
conversion → NVENC H.264 → WebRTC. It uses a one-frame CBR buffer, one encoder surface,
