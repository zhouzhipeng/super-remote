...
display aspect ratio, never crops the source, and is capped at the configured 1920x1200 encoder
ceiling for high-DPI browser compatibility. It uses a one-frame CBR buffer, two encoder surfaces,
